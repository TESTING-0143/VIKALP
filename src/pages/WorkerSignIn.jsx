        ...
        <div className="max-w-sm w-full">
          <div className="glass-card rounded-2xl shadow-card-lg p-6 border border-white/30 animate-fade-in">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-base">Sign in to access your work assignments</p>
            </div>
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600 text-sm">
                ...
                <Link to="/worker-signup" className="text-orange-600 font-bold hover:text-orange-700">
                  Sign up
                </Link>
              </p>
